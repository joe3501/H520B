...
ONE_DESCRIPTOR Device_Descriptor[2/*3*/] =
  {
	 // {
...
ONE_DESCRIPTOR Config_Descriptor[2/*3*/] =
  {
	 // {
...
void USB_Set_Descriptor(void)
{
	...
	{
		Device_Descriptor[0].Descriptor = (u8*)Keyboard_DeviceDescriptor;

		Config_Descriptor[0].Descriptor = (u8*)Keyboard_ConfigDescriptor;
		Config_Descriptor[0].Descriptor_Size	= KEYBOARD_SIZ_CONFIG_DESC;
	}
	else
	{
		Device_Descriptor[1].Descriptor = (u8*)MASS_DeviceDescriptor;

		Config_Descriptor[1].Descriptor = (u8*)MASS_ConfigDescriptor;
		Config_Descriptor[1].Descriptor_Size	= MASS_SIZ_CONFIG_DESC;
	}
}
